...
export const performMongoDbRequest = async function (databaseName) {
...
export const getObject = async function (dbP, collectionP, query, options) {
...
export const getConcept = async function (dbP, collectionP, conceptId, options) {
    const docs = await getObject(dbP, collectionP, { 'conceptId': conceptId }, options);
    return docs[0];
};

export const getDescriptions = async function (dbP, collectionP, conceptId, descriptionId, options) {
...
export const getRelationShips = async function (dbP, collectionP, conceptId, form, options) {
    const doc = await getConcept(dbP, collectionP, conceptId, options);
    const result = [];
...
export const getParents = async function (dbP, collectionP, conceptId, form, options) {
    const doc = await getConcept(dbP, collectionP, conceptId, options);
    const result = [];
...
export const getMembers = async function (dbP, collectionP, conceptId, options) {
    let query: any = { "memberships": { "$elemMatch": { "refset.conceptId": conceptId, "active": true } } };
    if (options.filter) {
    ...
    const getTotalOf = async function (refsetId) {
        ...
        let total = 0;
        let error: any = "No refset matching in the manifest";
...
export const searchDescription = async function (dbP, collectionP, filters, query, options) {
...
export const getDefaultTermType = async function (dbP, collectionP) {
